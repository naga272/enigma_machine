...
ATA = ./build/disk/disk.o
FILES = ./build/kernel.asm.o ./build/kernel.o $(ATA) $(IDT) ./build/test_int80h.asm.o ./build/io/io.asm.o $(UTILITIES) ./build/enigma/enigma.o
...
all: ./bin/boot.bin ./bin/kernel.bin
	...
	dd if=/dev/zero 		of=./bin/os.bin bs=512 seek=128 count=10 conv=notrunc
...
./build/disk/disk.o: ./src/utilities/disk/disk.c
	i686-elf-gcc $(INCLUDES) -I./src/video $(FLAGS) -std=gnu99 -c ./src/utilities/disk/disk.c -o ./build/disk/disk.o
