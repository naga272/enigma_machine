...
struct queue {
    struct entry_int_call queue[1024];
    volatile ushort tail;
    volatile ushort head;
    atomic_t locks_queue_updating;
}


#define SIZE_LIST_QUEUE 1024
#define PRIORITY_EXC_CPU 4
#define PRIORITY_PIC_MASTER 3
#define PRIORITY_PIC_SLAVE 2
#define PRIORITY_SYSCALL 1
