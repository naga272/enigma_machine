...
MODULE_DESCRIPTION("core della kmalloc, kcalloc, krealloc, kfree");
...
O3 ainline u32 heap_address_to_block(struct heap *heap, void* ptr)
{
...
O3 ainline u32 heap_align_value_to_upper(u32 val)
{
    /*
...
O3 ainline i32 heap_get_entry_type(HEAP_BLOCK_TABLE_ENTRY entry)
{
    return entry & 0x0f;
}
...
O3 ainline void heap_mark_blocks_taken(struct heap* heap, u32 start_block, u32 total_blocks_required)
{
...
O3 ainline void* heap_malloc_blocks(struct heap* heap, u32 total_blocks_required)
{
    void* address = 0;
...
O3 ainline void* heap_alloc(struct heap* heap, size_t size)
{
...
O3 ainline void heap_mark_blocks_free(struct heap *heap, u32 num_block)
{
...
O3 ainline void heap_free(struct heap* heap, void *addrs)
{
