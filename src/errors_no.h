...
#define EISTKN           8   /* impossible taken */
...
#define EINVARG         22   /* Invalid argument */
...
#define ELIBBAD         80   /* Accessing corrupted library */
#define ELIBSCN         81   /* .lib section corrupted */
#define ELIBMAX         82   /* Too many shared libraries */
#define ELIBEXEC        83   /* Cannot exec shared library */
...
#define EKEYREJECTED   129  /* Key rejected by service */

#define EOWNERDEAD     130  /* Owner died */
#define ENOTRECOVERABLE 131 /* State not recoverable */
#define ERFKILL        132  /* RF-kill active */
